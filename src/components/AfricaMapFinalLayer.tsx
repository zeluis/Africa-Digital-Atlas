...
export const AfricaMapFinalLayer: React.FC<AfricaMapFinalLayerProps> = ({
  ...
  const { mapData: streamedMap } = useAfricaFinalMap();
        ...
        {Object.values(finalMap).map(country => {
          ...
          return (
            ...
            >
              ...
              {/* Admin-1 subdivision paths streamed from public/africa-final.svg */}
              {country.admin1 && country.admin1.length > 0 ? (
                country.admin1.map(sub => {
                ...
                /* Sleek placeholder while streaming */
                country.centroid && (
                  <circle
