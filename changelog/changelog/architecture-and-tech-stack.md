...
At build/runtime, the app pulls from 16 external institutional APIs (World Bank, IMF, WHO, UNESCO, etc.), normalizes their responses into a common indicator schema, and caches them for offline use. See [Data Sources Catalog](https://fpizeluis.gitbook.io/fpizeluis-docs/api-reference/data-sources-catalog) for the full connector list.
